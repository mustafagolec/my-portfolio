...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home_title">Mustafa Göleç
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Simulation & Front-end Engineer</h3>
            <p className="home__description">Automotive Simulation Engineer & Front-end Developer from Turkey</p>
